...
### 20230427 学习和工作日报
#### 1. 封闭网络大概一个月高强度开发项目结束
#### 2. hbase,hive,flink服务都出现因为sssd服务异常导致服务出现访问权限的问题；
#### 3. Hetu问题通过视频会议得现和了解客户的问题
#### 4. 做任何事情都要遵守规则


### 20230428 学习和工作日报
#### 1. 生产环境排查节点根目录占据磁盘过满的异常问题
#### 2. 学习机器学习入门算法之回归
#### 3. 总结现在工作中的操作变更流程问题
#### 4. 回顾之前写的代码，增加注释，并作好问题总结


### 20230629 学习和工作日报
#### 1. 处理java代码不能说ssh的问题;
#### 2. 导数据调优化,增加Map数一周后,再观察和确定如何估算大概需要的资源;
#### 3. 参加招呼会议收集hetu遇到的问题,已经解决好连接hbase数据源的问题;
